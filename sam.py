...
def main():
    while True:
        ...
        if choice == "1":
            ...
            tokens.clear()
            tokens.extend([t.strip() for t in tokens_input if t.strip()])
            save_tokens(tokens)
            ...
            print("\nProgram berhenti. Terima kasih telah menggunakan bot faucet Discord!\n")
            sys.exit(0)
...
if __name__ == "__main__":
    try:
        ...
        print("\nProgram dihentikan oleh pengguna. Terima kasih sudah menggunakan bot faucet Discord!")
        sys.exit(0)
